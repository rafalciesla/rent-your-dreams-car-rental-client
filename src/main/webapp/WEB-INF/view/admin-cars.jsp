...
<div class="container main-container">
    ...
    <table class="table table-striped mt-4">
        ...
        <tr>
            <th>ID</th>
            <th>Name</th>
            <th class="d-md-table-cell d-none">Year</th>
            <th class="d-md-table-cell d-none">Is available</th>
            <th>Options</th>
        </tr>
        </thead>
        ...
        <c:forEach var="tempCar" items="${cars}">
            ...
            <tr>
                ...
                <td><a class="btn btn-primary" href="${pageContext.request.contextPath}/admin/car?carId=${tempCar.id}">More</a></td>
            </tr>
        </c:forEach>
