...
<div class="container main-container">
    ...
    <h1 class="d-md-flex d-none">Options:</h1>

    <div class="row mt-4">
        <div class="col-md-12 d-md-flex d-none">
            <a class="btn btn-secondary mr-2" href="${pageContext.request.contextPath}/admin/cars">Show all cars</a>
            <a class="btn btn-secondary mr-2" href="${pageContext.request.contextPath}/admin/cars/search">Search for a car</a>
            <a class="btn btn-secondary mr-2" href="${pageContext.request.contextPath}/admin/new/car">Add new car</a>
            <a class="btn btn-secondary mr-2" href="${pageContext.request.contextPath}/admin/accounts">Show all accounts</a>
        </div>

        <div class="col-sm-12 d-md-none">
            <dl class="mobile-options">
                <dd><a class="btn btn-secondary mr-2 w-100" href="${pageContext.request.contextPath}/admin/cars">Show all cars</a></dd>
                <dd><a class="btn btn-secondary mr-2 w-100" href="${pageContext.request.contextPath}/admin/cars/search">Search for a car</a></dd>
                <dd><a class="btn btn-secondary mr-2 w-100" href="${pageContext.request.contextPath}/admin/new/car">Add new car</a></dd>
                <dd><a class="btn btn-secondary mr-2 w-100" href="${pageContext.request.contextPath}/admin/accounts">Show all accounts</a></dd>
            </dl>
        </div>
    </div>
